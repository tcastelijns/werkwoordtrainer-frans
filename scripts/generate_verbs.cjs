...
const verbsList = [
  { id: "danser", infinitive: "danser", translation: "dansen", infinitiveTranslation: "dansen", group: "er", categoryId: "reg-er" },
  { id: "aimer", infinitive: "aimer", translation: "houden van", infinitiveTranslation: "houden van", group: "er", categoryId: "reg-er" },
  { id: "regarder", infinitive: "regarder", translation: "kijken", infinitiveTranslation: "kijken", group: "er", categoryId: "reg-er" },
  { id: "parler", infinitive: "parler", translation: "spreken", infinitiveTranslation: "spreken / praten", group: "er", categoryId: "reg-er" },
  { id: "écouter", infinitive: "écouter", translation: "luisteren", infinitiveTranslation: "luisteren", group: "er", categoryId: "reg-er" },
  { id: "donner", infinitive: "donner", translation: "geven", infinitiveTranslation: "geven", group: "er", categoryId: "reg-er" },
  { id: "attendre", infinitive: "attendre", translation: "wachten", infinitiveTranslation: "wachten", group: "re", categoryId: "reg-re" },
  { id: "répondre", infinitive: "répondre", translation: "antwoorden", infinitiveTranslation: "antwoorden", group: "re", categoryId: "reg-re" },
  { id: "perdre", infinitive: "perdre", translation: "verliezen", infinitiveTranslation: "verliezen", group: "re", categoryId: "reg-re" },
  { id: "vendre", infinitive: "vendre", translation: "verkopen", infinitiveTranslation: "verkopen", group: "re", categoryId: "reg-re" },
  { id: "entendre", infinitive: "entendre", translation: "horen", infinitiveTranslation: "horen", group: "re", categoryId: "reg-re" },
  { id: "descendre", infinitive: "descendre", translation: "afdalen", infinitiveTranslation: "afdalen", group: "re", categoryId: "reg-re", aux: "être" },
  { id: "rendre", infinitive: "rendre", translation: "teruggeven", infinitiveTranslation: "teruggeven", group: "re", categoryId: "reg-re" },
  { id: "réagir", infinitive: "réagir", translation: "reageren", infinitiveTranslation: "reageren", group: "ir", categoryId: "reg-ir" },
  { id: "choisir", infinitive: "choisir", translation: "kiezen", infinitiveTranslation: "kiezen", group: "ir", categoryId: "reg-ir" },
  { id: "grandir", infinitive: "grandir", translation: "groeien", infinitiveTranslation: "groeien", group: "ir", categoryId: "reg-ir" },
  { id: "finir", infinitive: "finir", translation: "eindigen", infinitiveTranslation: "eindigen", group: "ir", categoryId: "reg-ir" },
  { id: "vomir", infinitive: "vomir", translation: "overgeven", infinitiveTranslation: "overgeven", group: "ir", categoryId: "reg-ir" },
  { id: "grossir", infinitive: "grossir", translation: "dikker worden", infinitiveTranslation: "dikker worden", group: "ir", categoryId: "reg-ir" },
  { id: "guérir", infinitive: "guérir", translation: "genezen", infinitiveTranslation: "genezen", group: "ir", categoryId: "reg-ir" },
  { id: "rougir", infinitive: "rougir", translation: "blozen", infinitiveTranslation: "blozen", group: "ir", categoryId: "reg-ir" },
